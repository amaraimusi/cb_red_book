...
CREATE TABLE `bio_clss` (
  `id` int(11) NOT NULL,
  `bio_cls_name` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '綱名',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='bio_clss 綱テーブル（Biological class)';

--
-- テーブルのデータのダンプ `bio_clss`
--

INSERT INTO `bio_clss` (`id`, `bio_cls_name`, `note`, `sort_no`, `delete_flg`, `update_user`, `ip_addr`, `created`, `modified`) VALUES
(1, '鳥類', '', 1, 0, '', '', NULL, '2018-09-01 08:41:23'),
(2, '爬虫類', 'TEST', 2, 0, NULL, '::1', NULL, '2018-09-01 14:27:59'),
(3, '哺乳類', '', 3, 0, '', '', NULL, '2018-09-01 08:41:23'),
(4, '両生類', '', 4, 0, '', '', NULL, '2018-09-01 08:41:23'),
(5, '汽水・淡水魚', '', 5, 0, '', '', NULL, '2018-09-01 08:41:23');
...
CREATE TABLE `en_ctgs` (
  `id` int(11) NOT NULL,
  `en_ctg_name` varchar(255) DEFAULT NULL COMMENT '絶滅危惧種カテゴリー名',
  ...
  `created` datetime DEFAULT NULL COMMENT '生成日時',
  `modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新日'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='en_ctgs Endangered category(絶滅危惧種カテゴリー)';

--
-- テーブルのデータのダンプ `en_ctgs`
--

INSERT INTO `en_ctgs` (`id`, `en_ctg_name`, `note`, `sort_no`, `delete_flg`, `update_user`, `ip_addr`, `created`, `modified`) VALUES
(1, '危急種', '', 0, 0, NULL, NULL, NULL, '2018-09-01 10:26:22'),
(2, '希少種', '', 0, 0, NULL, NULL, NULL, '2018-09-01 10:26:22'),
(3, '個体群', '', 0, 0, NULL, NULL, NULL, '2018-09-01 10:26:22'),
(4, '準絶滅危惧', '', 0, 0, NULL, NULL, NULL, '2018-09-01 10:26:22'),
(5, '情報不足', '', 0, 0, NULL, NULL, NULL, '2018-09-01 10:26:22'),
(6, '絶滅', '', 0, 0, NULL, NULL, NULL, '2018-09-01 10:26:22'),
(7, '絶滅危惧IA類', '', 0, 0, NULL, NULL, NULL, '2018-09-01 10:26:22'),
(8, '絶滅危惧IB類', '', 0, 0, NULL, NULL, NULL, '2018-09-01 10:26:22'),
(9, '絶滅危惧II類', '', 0, 0, NULL, NULL, NULL, '2018-09-01 10:26:22'),
(10, '絶滅危惧種', '', 0, 0, NULL, NULL, NULL, '2018-09-01 10:26:22'),
(11, '絶滅種', '', 0, 0, NULL, NULL, NULL, '2018-09-01 10:26:22'),
(12, '地域個体群', '', 0, 0, NULL, NULL, NULL, '2018-09-01 10:26:22'),
(13, '野生絶滅', '', 0, 0, NULL, NULL, NULL, '2018-09-01 10:26:22');
...
(1, 4, 'サンショウウオ', 'アベサンショウウオ', 'Hynobius abei', 7, 0, '', 1, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(2, 4, 'サンショウウオ', 'アカイシサンショウウオ', 'Hynobius katoi', 8, 0, '', 2, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(3, 4, 'サンショウウオ', 'ハクバサンショウウオ', 'Hynobius hidamontanus', 8, 0, '', 3, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(4, 4, 'サンショウウオ', 'ホクリクサンショウウオ', 'Hynobius takedai', 8, 0, '', 4, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(5, 4, 'サンショウウオ', 'オオイタサンショウウオ', 'Hynobius dunni', 9, 0, '1997年版から、「高知県のオオイタサンショウウオ個体群」も含む。', 5, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(6, 4, 'サンショウウオ', 'オオダイガハラサンショウウオ', 'Hynobius boulengeri', 9, 0, '1997年版まで、「本州・九州地域のオオダイガハラサンショウウオ個体群」を評価単位としていた。', 6, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(7, 4, 'サンショウウオ', 'オキサンショウウオ', 'Hynobius okiensis', 9, 0, '', 7, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(8, 4, 'サンショウウオ', 'カスミサンショウウオ', 'Hynobius nebulosus', 9, 0, '1997年版まで、「京都・大阪地域のカスミサンショウウオ個体群」を評価単位としていた。さらに、「愛知県のトウキョウサンショウウオ個体群」も分類の変更により含まれる。', 8, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(9, 4, 'サンショウウオ', 'トウキョウサンショウウオ', 'Hynobius tokyoensis', 9, 0, '1997年版まで、「東京都のトウキョウサンショウウオ個体群」を評価単位としていた。', 9, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(10, 4, 'サンショウウオ', 'ベッコウサンショウウオ', 'Hynobius stejnegeri', 9, 0, '', 10, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(11, 4, 'サンショウウオ', 'キタサンショウウオ', 'Salamandrella keyserlingii', 4, 0, '', 11, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(12, 4, 'サンショウウオ', 'イシヅチサンショウウオ', 'Hynobius hirosei', 4, 0, 'オオダイガハラサンショウウオ四国個体群とされていたものが独立種となった。', 12, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(13, 4, 'サンショウウオ', 'クロサンショウウオ', 'Hynobius nigrescens', 4, 0, '', 13, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(14, 4, 'サンショウウオ', 'コガタブチサンショウウオ', 'Hynobius yatsui', 4, 0, 'ブチサンショウウオの山地小型個体群とされていたものが独立種となった', 14, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(15, 4, 'サンショウウオ', 'ツシマサンショウウオ', 'Hynobius tsuensis', 4, 0, '', 15, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(16, 4, 'サンショウウオ', 'トウホクサンショウウオ', 'Hynobius lichenatus', 4, 0, '', 16, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(17, 4, 'サンショウウオ', 'ヒダサンショウウオ', 'Hynobius kimurae', 4, 0, '', 17, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(18, 4, 'サンショウウオ', 'ブチサンショウウオ', 'Hynobius naevius', 4, 0, '', 18, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(19, 4, 'サンショウウオ', 'エゾサンショウウオ', 'Hynobius retardatus', 5, 0, '', 19, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(20, 4, 'オオサンショウウオ', 'オオサンショウウオ', 'Andrias japonicus', 9, 0, '', 20, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(21, 4, 'イモリ', 'イボイモリ', 'Echinotriton andersoni', 9, 0, '', 21, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(22, 4, 'イモリ', 'アカハライモリ', 'Cynops pyrrhogaster', 4, 0, '', 22, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(23, 4, 'イモリ', 'シリケンイモリ', 'Cynops ensicauda', 4, 0, '', 23, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(24, 4, 'ヒキガエル', 'ミヤコヒキガエル', 'Bufo gargarizans miyakonis', 4, 0, '', 24, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(25, 4, 'アカガエル', 'アマミイシカワガエル', 'Odorrana splendida', 8, 0, 'イシカワガエルの奄美大島個体群とされていたものが独立種となった。', 25, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(26, 4, 'アカガエル', 'オキナワイシカワガエル', 'Odorrana ishikawae', 8, 0, '2006年版まで、和名をイシカワガエルとしていた。アマミイシカワガエル備考欄の理由により沖縄島個体群のみがO. ishikawaeとなり、それに伴い和名が変更された。', 26, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(27, 4, 'アカガエル', 'コガタハナサキガエル', 'Odorrana utsunomiyaorum', 8, 0, '', 27, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(28, 4, 'アカガエル', 'オットンガエル', 'Babina subaspera', 8, 0, '', 28, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(29, 4, 'アカガエル', 'ナゴヤダルマガエル', 'Rana porosa brevipoda', 8, 0, '1997年版まで、和名をダルマガエルとしていた。', 29, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(30, 4, 'アカガエル', 'ナミエガエル', 'Limnonectes namiyei', 8, 0, '', 30, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(31, 4, 'アカガエル', 'ホルストガエル', 'Babina holsti', 8, 0, '', 31, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(32, 4, 'アカガエル', 'アマミハナサキガエル', 'Odorrana amamiensis', 9, 0, '', 32, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(33, 4, 'アカガエル', 'ハナサキガエル', 'Odorrana narina', 9, 0, '', 33, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(34, 4, 'アカガエル', 'ヤエヤマハラブチガエル', 'Rana okinavana', 9, 0, '2006年版まで学名がRana psaltesだったが、リュウキュウアカガエルの学名とされていたR. okinavanaの模式標本がヤエヤマハラブチガエルであったことが判明したため学名が変更された。', 34, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(35, 4, 'アカガエル', 'アマミアカガエル', 'Rana kobai', 4, 0, 'リュウキュウアカガエルの奄美諸島個体群とされていたものが独立種となった', 35, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(36, 4, 'アカガエル', 'オキタゴガエル', 'Rana tagoi okiensis', 4, 0, '', 36, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(37, 4, 'アカガエル', 'ヤクシマタゴガエル', 'Rana tagoi yakushimensis', 4, 0, '', 37, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(38, 4, 'アカガエル', 'トウキョウダルマガエル', 'Rana porosa porosa', 4, 0, '', 38, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(39, 4, 'アカガエル', 'チョウセンヤマアカガエル', 'Rana dybowskii', 4, 0, '', 39, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(40, 4, 'アカガエル', 'ツシマアカガエル', 'Rana tsushimensis', 4, 0, '', 40, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(41, 4, 'アカガエル', 'トノサマガエル', 'Rana nigromaculata', 4, 0, '', 41, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(42, 4, 'アカガエル', 'リュウキュウアカガエル', 'Rana ulma', 4, 0, '2006年版まで学名がRana okinavanaだったが、R. okinavanaの模式標本がヤエヤマハラブチガエルであったことが判明したため改めて新種として記載された。', 42, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(43, 2, 'ウミガメ', 'アカウミガメ', 'Caretta caretta', 8, 0, '', 43, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(44, 2, 'ウミガメ', 'タイマイ', 'Eretmochelys imbricata', 8, 0, '', 44, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(45, 2, 'ウミガメ', 'アオウミガメ', 'Chelonia mydas mydas', 9, 0, '', 45, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(46, 2, 'イシガメ', 'ヤエヤマセマルハコガメ', 'Cuora flavomarginata evelynae', 9, 0, '1997年版まで、和名をセマルハコガメとしていた。', 46, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(47, 2, 'イシガメ', 'リュウキュウヤマガメ', 'Geoemyda japonica', 9, 0, '', 47, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(48, 2, 'イシガメ', 'ニホンイシガメ', 'Mauremys japonica', 4, 0, '', 48, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
(49, 2, 'スッポン', 'ニホンスッポン', 'Pelodiscus sinensis', 5, 0, '1997年版までスッポンを、2006年版ではP. s. japonicusとして評価していた。', 49, 0, NULL, NULL, NULL, '2018-09-01 11:20:37'),
...
(273, 3, 'オオコウモリ', 'ミヤココキクガシラコウモリ', 'Rhinolophus pumilus miyakonis', 6, 0, '', 273, 0, NULL, NULL, NULL, '2018-09-01 11:20:39'),
...
--
-- Indexes for table `bio_clss`
--
ALTER TABLE `bio_clss`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `en_ctgs`
--
ALTER TABLE `en_ctgs`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `en_sps`
--
ALTER TABLE `en_sps`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `bio_clss`
--
ALTER TABLE `bio_clss`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `en_ctgs`
--
ALTER TABLE `en_ctgs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `en_sps`
--
ALTER TABLE `en_sps`
